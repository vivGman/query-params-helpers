 ...
 * 
 * @param {String} queryString - Query string. May include host and hash. If string not include query params thish function will parse hash params
 * @param {Object} options
 * @param {String} [options.output=tree] - Output format. This parameter must be an array or tree.
 * @param {Boolean} [options.conversion=true] - If false, numbers and boolean values will be a strings
 * @return {Object|Array}
 *
 * @example
